...
// Tier-3 suite: drives REAL MCP hosts against the
// tier-2 fixture. Needs host binaries and model credentials, spends real
...
export default defineConfig({
  test: {
    ...
    // 120s ready + 780s elicitation + 120s render + 120s answer = 1140s), so
